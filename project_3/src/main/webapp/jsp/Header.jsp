				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item"
							href="<%=ORSView.PORTFOLIOMANAGEMENT_CTL%>"> <i
							class="far fa-file"></i>Add PortfolioManagement
						</a> <a class="dropdown-item"
							href="<%=ORSView.PORTFOLIOMANAGEMENT_LIST_CTL%>"> <i
							class="fas fa-paste"></i>PortfolioManagement List
							...
							<li class="nav-item dropdown" style="padding-left: 5px"><a
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="<%=ORSView.MARKSHEET_CTL%>">
										...
										class="fas fa-paste"></i>Marksheet List
									</a> <a class="dropdown-item"
										href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>"> <i
							...
							<li class="nav-item dropdown" style="padding-left: 5px"><a
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="<%=ORSView.TIMETABLE_CTL%>"><i
										class="fas fa-clock"></i>Add TimeTable</a> <a
							...
							style="padding-left: 5px; padding-right: 67px"><a
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item"
										...
										class="dropdown-item" href="<%=ORSView.CHANGE_PASSWORD_CTL%>">
